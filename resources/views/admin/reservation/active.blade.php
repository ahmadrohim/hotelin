...
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="mb-4">
        <h1 class="h4 mb-0 text-gray-800 text-uppercase">Daftar Pemesanan Aktif</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-end">
            <form action="/reservation/active" class="d-none d-sm-inline-block form-inline ml-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    ...
                    <tbody class="text-dark">
                        ...
                        <tr>
                            ...
                            <td class="text-center m-0 p-1 align-middle">
                                <a href="/reservation/{{ $reservation->code_booking }}?from=active" class="btn btn-info btn-sm m-0">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </td>
                            <td class="text-center m-0 p-1 align-middle">
                                <a href="/reservation/edit/{{ $reservation->code_booking }}?from=active" class="btn btn-warning btn-sm m-0">
